...
stripe.api_key="sk_test_51MvxCKSBm2X4UHAqvoFaRgFftYfng3D1wobzXcgMdQrR45eCQkW7YrBFse64KZVXmuOgU42Pd4t2vAoQPNdn2X7S00uX0Z5g3M"
app=Flask(__name__)
...
def create():
    ...
    if result>0:
        ...
        if request.method=='POST':
            ...
            email='kaveri.ravilla25@gmail.com'
            otp=genotp()
